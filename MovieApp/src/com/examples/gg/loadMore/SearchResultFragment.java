...
public class SearchResultFragment extends LoadMore_Base {
	...
	public void Initializing() {
		...
		// set a feed manager
		feedManager = new FeedManager_Base_v3("video", api, browserKey, gv,
				numOfResults);
	...
	public String buildAPI(String q) {
		...
		try {
			...
			api = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults="
					+ numOfResults
					+ "&order=relevance&q="
					+ URLEncoder.encode(q, "UTF-8")
					+ "&type=video&videoDuration=long&key=" + browserKey;
//			Log.i("debug", api);
