...
public class SideMenuActivity extends SherlockFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		items.add(new EntryItem("What's New", "Your daily top movies",
				R.drawable.live));

		// Music Playlists
		items.add(new SectionItem("Categories"));
		items.add(new EntryItem("Action", null, R.drawable.highlights));
		items.add(new EntryItem("Adventure", null, R.drawable.highlights));
		items.add(new EntryItem("Animation", null, R.drawable.highlights));
		items.add(new EntryItem("Comedy", null, R.drawable.highlights));
		items.add(new EntryItem("Fantasy", null, R.drawable.highlights));
		items.add(new EntryItem("Horror", null, R.drawable.highlights));
		items.add(new EntryItem("Romance", null, R.drawable.highlights));
		items.add(new EntryItem("Sci-Fi", null, R.drawable.highlights));
		items.add(new EntryItem("Thriller", null, R.drawable.highlights));
		items.add(new EntryItem("War", null, R.drawable.highlights));
		
		// Favorites
		items.add(new SectionItem("My Movies"));
...
//		this.validatingTips(this);
	...
	private void selectItem(int position) {
		...
		case 1:
			// News
			ft.replace(R.id.content_frame, new SearchResultFragment("movie full 2014",
					"What's New"));
			break;
		...
		case 3:
			ft.replace(R.id.content_frame, new SearchResultFragment("action movie full 2014",
					"Action"));
			break;
		case 4:
			ft.replace(R.id.content_frame, new SearchResultFragment("Adventure movie full 2014",
					"Adventure"));
			break;
		case 5:
			ft.replace(R.id.content_frame, new SearchResultFragment("Animation movie full 2014",
					"Animation"));
			break;
		case 6:
			ft.replace(R.id.content_frame, new SearchResultFragment("Comedy movie full 2014",
					"Comedy"));
			break;
		case 7:
			ft.replace(R.id.content_frame, new SearchResultFragment("Fantasy movie full 2014",
					"Fantasy"));
			break;
		case 8:
			ft.replace(R.id.content_frame, new SearchResultFragment("Horror movie full 2014",
					"Horror"));
			break;
			
		case 9:
			ft.replace(R.id.content_frame, new SearchResultFragment("Romantic movie full 2014",
					"Romance"));
			break;
			
		case 10:
			ft.replace(R.id.content_frame, new SearchResultFragment("Sci-Fi movie full 2014",
					"Sci-Fi"));
			break;
		case 11:
			ft.replace(R.id.content_frame, new SearchResultFragment("Thriller movie full 2014",
					"Thriller"));
			break;
		case 12:
			ft.replace(R.id.content_frame, new SearchResultFragment("War movie full 2014",
					"War"));
			break;
